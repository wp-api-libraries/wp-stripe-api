...
if ( ! class_exists( 'StripeAPI' ) ) {
     ...
     *
		 ...
		 * @param  string $product  The product whose pricing the created plan will represent. This can either be the ID of
		 ...
		 */
		public function create_plan( string $currency, string $interval, string $product, string $id = '' ) {
